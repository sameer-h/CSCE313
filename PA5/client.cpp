...
void file_thread_function(void* info)
{
	...
	TCPRequestChannel* control = dat->	control;
...
void worker_thread_function(BoundedBuffer* requestBuffer, TCPRequestChannel* chan, BoundedBuffer* resb, int buffercapacity)
{
